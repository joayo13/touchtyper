...
function Introduction({playerOne, playerTwo, setLevel}) {
  return (
    <div className='flex flex-col items-center justify-center text-gray-300'>
      ...
      <p className='max-w-xl text-3xl'>Don't worry, the first level will be an easy one..</p>
      <button onClick={() => setLevel(1)} className='animate-pulse bg-green-700 block mx-auto my-4 py-8 px-16 text-6xl'>Continue</button>
    </div>
  )
}
